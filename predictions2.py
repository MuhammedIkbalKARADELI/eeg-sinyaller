...
x_lstm = LSTM(512, return_sequences=True,kernel_regularizer=regularizers.l2(0.01))(i_lstm)
x_lstm = Flatten()(x_lstm)
x_lstm = Dense(128, activation='relu')(x_lstm)  
...
mc = ModelCheckpoint('./best_lstm_model_new.h5', monitor='val_accuracy', mode='max', verbose=1, save_best_only=True)
...
lstm_best = load_model('./best_lstm_model_new.h5')
